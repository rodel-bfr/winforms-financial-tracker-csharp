...
!\[Dashboard Screenshot](YOUR\_IMAGE\_URL\_HERE)

!\[Categories Screenshot](YOUR\_IMAGE\_URL\_HERE)

!\[Budget Rules Screenshot](YOUR\_IMAGE\_URL\_HERE)

!\[Add Transaction Screenshot](YOUR\_IMAGE\_URL\_HERE)

!\[Server API Screenshot](YOUR\_IMAGE\_URL\_HERE)
...
2\.  Open the `sql\_files/database.sql` file from this project.
...
1\.  Open the `server\_app/server\_app.sln` solution file in Visual Studio.
...
&nbsp;   \*Example: `AttachDbFilename=C:\\Users\\Rodel\\Desktop\\win-app-financial-tracker\\server\_app\\server\_app\\App\_Data\\Database1.mdf`\*
...
2\.  Open the `clinet\_app/clinet\_app.sln` solution file.
